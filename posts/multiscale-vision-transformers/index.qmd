...
The first step of Multi Head Pooling Attention (MHPA) is to project the input tensor $X$ into intermerdiate tensors:
...
If you downsample space-time resolution by 4X, you increase channels by 2X. So a resolution change from $2D \times \frac{T}{δ_t} \times \frac{H}{8} \times \frac{W}{8}$ to $4D \times \frac{T}{δ_t} \times \frac{H}{16} \times \frac{W}{16}$ roughly preserves computational complexity while building a hierarchical feature pyramid. This is essentially applying the CNN principle of "deeper = more channels, lower resolution" to video transformers.
